  ...
  return new Promise((resolve, reject) => {
    ...
    if (
      ...
      args.pageDestination = node_process_argv
        ...
        .slice(5);
      if (
        args.pageDestination.slice(0, 2) === "./" &&
        args.pageDestination.length !== 2
      ) {
        args.pageDestination = args.pageDestination.slice(2);
      } else if (args.pageDestination.slice(0, 1) === "/") {
    ...
    if (args.react_cli || args.vue_cli || args.angular_cli) {
      ...
      // Set Framework Type.
      if (args.react_cli) {
        args.framework_type = "react";
      } else if (args.vue_cli) {
        args.framework_type = "vue";
      } else if (args.angular_cli) {
        args.framework_type = "angular";
      }
    }
